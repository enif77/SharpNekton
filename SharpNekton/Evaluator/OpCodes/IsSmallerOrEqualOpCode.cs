...
namespace SharpNekton.Evaluator.OpCodes
{
  ...
  class IsSmallerOrEqualOpCode : AOpCode {
    public IsSmallerOrEqualOpCode(int line, int linePosition) : base(line, linePosition) 
    {
      opCodeID = OpCodeID.O_IS_SMALLER_OR_EQUAL;
    }
