...
namespace SharpNekton.Evaluator.OpCodes 
{
  ...
  class IsGreatherOrEqualOpCode:AOpCode {
    public IsGreatherOrEqualOpCode(int line, int linePosition) : base(line, linePosition)  
    {
      opCodeID = OpCodeID.O_IS_GREATHER_OR_EQUAL;
    }


    public override string ToString() 
    {
      return "is_greather_or_equal";
    }
